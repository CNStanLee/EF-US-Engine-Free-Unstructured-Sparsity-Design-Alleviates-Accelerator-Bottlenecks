...
module finn_design
  ...
  output [1:0]maxcount_10;
  output [1:0]maxcount_11;
  output [1:0]maxcount_12;
  output [9:0]maxcount_2;
  output [9:0]maxcount_3;
  output [7:0]maxcount_4;
  output [6:0]maxcount_5;
  output [6:0]maxcount_6;
  output [8:0]maxcount_7;
  output [8:0]maxcount_8;
  output [1:0]maxcount_9;
  ...
  wire [1:0]StreamingFIFO_rtl_10_maxcount;
  ...
  wire [1:0]StreamingFIFO_rtl_11_maxcount;
  ...
  wire [1:0]StreamingFIFO_rtl_12_maxcount;
  ...
  assign maxcount_10[1:0] = StreamingFIFO_rtl_10_maxcount;
  assign maxcount_11[1:0] = StreamingFIFO_rtl_11_maxcount;
  assign maxcount_12[1:0] = StreamingFIFO_rtl_12_maxcount;
  ...
  assign maxcount_5[6:0] = StreamingFIFO_rtl_5_maxcount;
  assign maxcount_6[6:0] = StreamingFIFO_rtl_6_maxcount;
  assign maxcount_7[8:0] = StreamingFIFO_rtl_7_maxcount;
  assign maxcount_8[8:0] = StreamingFIFO_rtl_8_maxcount;
  assign maxcount_9[1:0] = StreamingFIFO_rtl_9_maxcount;
