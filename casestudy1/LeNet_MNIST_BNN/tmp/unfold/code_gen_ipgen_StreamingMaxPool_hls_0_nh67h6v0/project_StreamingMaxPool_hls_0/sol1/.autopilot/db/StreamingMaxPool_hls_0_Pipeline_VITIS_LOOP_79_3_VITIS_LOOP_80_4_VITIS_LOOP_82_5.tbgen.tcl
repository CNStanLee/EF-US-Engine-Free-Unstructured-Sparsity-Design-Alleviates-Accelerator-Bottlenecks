set moduleName StreamingMaxPool_hls_0_Pipeline_VITIS_LOOP_79_3_VITIS_LOOP_80_4_VITIS_LOOP_82_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {StreamingMaxPool_hls_0_Pipeline_VITIS_LOOP_79_3_VITIS_LOOP_80_4_VITIS_LOOP_82_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ in0_V int 8 regular {axi_s 0 volatile  { in0_V Data } }  }
	{ buf_V int 6 regular {array 14 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "buf_V", "interface" : "memory", "bitwidth" : 6, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ buf_V_address0 sc_out sc_lv 4 signal 1 } 
	{ buf_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf_V_we0 sc_out sc_logic 1 signal 1 } 
	{ buf_V_d0 sc_out sc_lv 6 signal 1 } 
	{ buf_V_address1 sc_out sc_lv 4 signal 1 } 
	{ buf_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ buf_V_q1 sc_in sc_lv 6 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "buf_V", "role": "d0" }} , 
 	{ "name": "buf_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "buf_V", "role": "address1" }} , 
 	{ "name": "buf_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_V", "role": "ce1" }} , 
 	{ "name": "buf_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "buf_V", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	buf_V { ap_memory {  { buf_V_address0 mem_address 1 4 }  { buf_V_ce0 mem_ce 1 1 }  { buf_V_we0 mem_we 1 1 }  { buf_V_d0 mem_din 1 6 }  { buf_V_address1 MemPortADDR2 1 4 }  { buf_V_ce1 MemPortCE2 1 1 }  { buf_V_q1 in_data 0 6 } } }
}
