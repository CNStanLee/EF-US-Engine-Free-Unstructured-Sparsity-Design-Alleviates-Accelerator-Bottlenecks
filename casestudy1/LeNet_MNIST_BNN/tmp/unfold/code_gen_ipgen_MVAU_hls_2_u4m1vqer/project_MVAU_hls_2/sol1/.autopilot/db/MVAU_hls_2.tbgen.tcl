...
set C_modelArgList {
	...
	{ out0_V int 120 regular {axi_s 1 volatile  { out0_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V", "interface" : "axis", "bitwidth" : 400, "direction" : "READONLY"} , 
 	{ "Name" : "out0_V", "interface" : "axis", "bitwidth" : 120, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out0_V_TDATA sc_out sc_lv 120 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out0_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "out0_V", "role": "TDATA" }} , 
...
set ArgLastReadFirstWriteLatency {
	MVAU_hls_2 {
		...
		out0_V {Type O LastRead -1 FirstWrite 6}}
...
set Spec2ImplPortList { 
	...
	out0_V { axis {  { out0_V_TDATA out_data 1 120 }  { out0_V_TVALID out_vld 1 1 }  { out0_V_TREADY out_acc 0 1 } } }
}
