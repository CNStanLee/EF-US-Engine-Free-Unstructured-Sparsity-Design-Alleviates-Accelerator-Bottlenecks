...
set C_modelArgList {
	{ in0_V int 120 regular {axi_s 0 volatile  { in0_V Data } }  }
	{ out0_V int 88 regular {axi_s 1 volatile  { out0_V Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in0_V", "interface" : "axis", "bitwidth" : 120, "direction" : "READONLY"} , 
 	{ "Name" : "out0_V", "interface" : "axis", "bitwidth" : 88, "direction" : "WRITEONLY"} ]}
# RTL Port declarations: 
set portNum 8
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst_n sc_in sc_logic 1 reset -1 active_low_sync } 
	{ in0_V_TDATA sc_in sc_lv 120 signal 0 } 
	{ in0_V_TVALID sc_in sc_logic 1 invld 0 } 
	{ in0_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ out0_V_TDATA sc_out sc_lv 88 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in0_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "in0_V", "role": "TDATA" }} , 
 	...
 	{ "name": "out0_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":88, "type": "signal", "bundle":{"name": "out0_V", "role": "TDATA" }} , 
...
set ArgLastReadFirstWriteLatency {
	MVAU_hls_3 {
		...
		out0_V {Type O LastRead -1 FirstWrite 3}}
...
set Spec2ImplPortList { 
	in0_V { axis {  { in0_V_TDATA in_data 0 120 }  { in0_V_TVALID in_vld 0 1 }  { in0_V_TREADY in_acc 1 1 } } }
	out0_V { axis {  { out0_V_TDATA out_data 1 88 }  { out0_V_TVALID out_vld 1 1 }  { out0_V_TREADY out_acc 0 1 } } }
}
