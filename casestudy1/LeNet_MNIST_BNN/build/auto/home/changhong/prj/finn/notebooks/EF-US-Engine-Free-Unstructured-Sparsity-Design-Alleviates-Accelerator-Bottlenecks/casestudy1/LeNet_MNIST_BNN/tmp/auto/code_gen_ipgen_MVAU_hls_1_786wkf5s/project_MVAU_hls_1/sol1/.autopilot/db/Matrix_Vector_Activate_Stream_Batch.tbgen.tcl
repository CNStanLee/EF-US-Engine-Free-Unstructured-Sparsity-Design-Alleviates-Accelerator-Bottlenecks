...
set portList { 
	...
	{ in1_V_TDATA sc_in sc_lv 240 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_53_30_1_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	in1_V { axis {  { in1_V_TVALID in_vld 0 1 }  { in1_V_TDATA in_data 0 240 }  { in1_V_TREADY in_acc 1 1 } } }
}
