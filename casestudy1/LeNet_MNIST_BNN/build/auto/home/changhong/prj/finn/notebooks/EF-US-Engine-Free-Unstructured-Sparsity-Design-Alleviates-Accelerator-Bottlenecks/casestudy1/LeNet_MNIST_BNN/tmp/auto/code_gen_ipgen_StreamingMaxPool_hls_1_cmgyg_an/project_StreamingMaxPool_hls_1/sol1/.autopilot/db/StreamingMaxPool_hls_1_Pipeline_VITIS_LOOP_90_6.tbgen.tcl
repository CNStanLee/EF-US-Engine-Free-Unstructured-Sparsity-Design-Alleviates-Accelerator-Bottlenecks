set moduleName StreamingMaxPool_hls_1_Pipeline_VITIS_LOOP_90_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {StreamingMaxPool_hls_1_Pipeline_VITIS_LOOP_90_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_V int 16 regular {array 5 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ buf_V_d0 sc_out sc_lv 16 signal 0 } 
	{ buf_V_q0 sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "buf_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	buf_V { ap_memory {  { buf_V_address0 mem_address 1 3 }  { buf_V_ce0 mem_ce 1 1 }  { buf_V_we0 mem_we 1 1 }  { buf_V_d0 mem_din 1 16 }  { buf_V_q0 in_data 0 16 } } }
	out0_V { axis {  { out0_V_TREADY out_acc 0 1 }  { out0_V_TDATA out_data 1 16 }  { out0_V_TVALID out_vld 1 1 } } }
}
