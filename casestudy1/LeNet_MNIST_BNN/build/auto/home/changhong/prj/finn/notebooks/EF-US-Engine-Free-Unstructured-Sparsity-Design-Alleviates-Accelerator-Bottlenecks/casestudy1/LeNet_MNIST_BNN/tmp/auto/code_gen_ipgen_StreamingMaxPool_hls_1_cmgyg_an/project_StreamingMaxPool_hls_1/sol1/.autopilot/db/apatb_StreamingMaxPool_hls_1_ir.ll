...
define void @apatb_StreamingMaxPool_hls_1_ir(%"class.hls::stream<ap_uint<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %in0_V, %"class.hls::stream<ap_uint<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %out0_V) local_unnamed_addr #1 {
entry:
  %in0_V_copy = alloca %"class.hls::stream<ap_uint<16>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ap_uint<16>, 0>"* %in0_V_copy, i32 0) ]
  %out0_V_copy = alloca %"class.hls::stream<ap_uint<16>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ap_uint<16>, 0>"* %out0_V_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<16>, 0>"* nonnull %in0_V, %"class.hls::stream<ap_uint<16>, 0>"* nonnull align 512 %in0_V_copy, %"class.hls::stream<ap_uint<16>, 0>"* nonnull %out0_V, %"class.hls::stream<ap_uint<16>, 0>"* nonnull align 512 %out0_V_copy)
  call void @apatb_StreamingMaxPool_hls_1_hw(%"class.hls::stream<ap_uint<16>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<16>, 0>"* %out0_V_copy)
  call void @copy_back(%"class.hls::stream<ap_uint<16>, 0>"* %in0_V, %"class.hls::stream<ap_uint<16>, 0>"* %in0_V_copy, %"class.hls::stream<ap_uint<16>, 0>"* %out0_V, %"class.hls::stream<ap_uint<16>, 0>"* %out0_V_copy)
  ret void
}
...
declare void @apatb_StreamingMaxPool_hls_1_hw(%"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<ap_uint<16>, 0>"*)
...
define void @StreamingMaxPool_hls_1_hw_stub_wrapper(%"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<ap_uint<16>, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %0, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %1)
  call void @StreamingMaxPool_hls_1_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"* %0, %"class.hls::stream<ap_uint<16>, 0>"* %1)
  call void @copy_in(%"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %0, %"class.hls::stream<ap_uint<16>, 0>"* null, %"class.hls::stream<ap_uint<16>, 0>"* %1)
  ret void
}

declare void @StreamingMaxPool_hls_1_hw_stub(%"class.hls::stream<ap_uint<16>, 0>"*, %"class.hls::stream<ap_uint<16>, 0>"*)
