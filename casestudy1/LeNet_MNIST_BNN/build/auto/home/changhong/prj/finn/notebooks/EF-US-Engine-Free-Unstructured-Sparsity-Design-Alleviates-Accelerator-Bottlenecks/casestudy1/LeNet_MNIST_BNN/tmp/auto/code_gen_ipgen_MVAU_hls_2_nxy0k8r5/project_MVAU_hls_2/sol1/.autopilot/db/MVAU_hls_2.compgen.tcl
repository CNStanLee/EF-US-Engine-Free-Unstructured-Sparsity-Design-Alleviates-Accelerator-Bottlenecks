...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in1_V_TDATA { I 56 vector } in1_V_TVALID { I 1 bit } in1_V_TREADY { O 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 11
set RegSliceName MVAU_hls_2_regslice_both
set RegSliceInstName MVAU_hls_2_regslice_both_U
set CoreName ap_simcore_MVAU_hls_2_regslice_both
