...
set id 1
set name MVAU_hls_4_mux_847_1_1_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in1_V_TVALID { I 1 bit } in1_V_TDATA { I 8 vector } in1_V_TREADY { O 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 6
set RegSliceName MVAU_hls_4_regslice_both
set RegSliceInstName MVAU_hls_4_regslice_both_U
set CoreName ap_simcore_MVAU_hls_4_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set InstName MVAU_hls_4_flow_control_loop_pipe_no_ap_cont_U
set CompName MVAU_hls_4_flow_control_loop_pipe_no_ap_cont
