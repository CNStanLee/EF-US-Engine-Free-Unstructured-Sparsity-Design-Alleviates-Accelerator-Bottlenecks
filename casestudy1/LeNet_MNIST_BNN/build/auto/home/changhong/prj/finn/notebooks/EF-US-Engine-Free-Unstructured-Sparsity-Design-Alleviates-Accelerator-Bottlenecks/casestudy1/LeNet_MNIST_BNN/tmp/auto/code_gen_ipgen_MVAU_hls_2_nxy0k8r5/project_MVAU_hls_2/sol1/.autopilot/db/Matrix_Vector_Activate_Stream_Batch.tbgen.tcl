...
set portList { 
	...
	{ in1_V_TDATA sc_in sc_lv 56 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_164_25_1_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	in1_V { axis {  { in1_V_TVALID in_vld 0 1 }  { in1_V_TDATA in_data 0 56 }  { in1_V_TREADY in_acc 1 1 } } }
}
