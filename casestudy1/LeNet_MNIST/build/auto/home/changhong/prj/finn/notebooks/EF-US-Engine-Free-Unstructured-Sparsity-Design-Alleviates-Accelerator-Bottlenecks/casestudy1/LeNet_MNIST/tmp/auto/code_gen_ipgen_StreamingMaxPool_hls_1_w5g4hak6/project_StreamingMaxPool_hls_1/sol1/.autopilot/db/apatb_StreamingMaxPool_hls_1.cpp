...
#define AUTOTB_TVOUT_out_V "../tv/cdatafile/c.StreamingMaxPool_hls_1.autotvout_out_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_V "../tv/rtldatafile/rtl.StreamingMaxPool_hls_1.autotvout_out_V.dat"
...
extern "C"
void apatb_StreamingMaxPool_hls_1_hw(void* __xlx_apatb_param_in0_V, void* __xlx_apatb_param_out_V)
{
  ...
  port1.param = (hls::stream<hls::sim::Byte<64>>*)__xlx_apatb_param_out_V;
  port1.hasWrite = true;
  ...
  try {
    ...
    StreamingMaxPool_hls_1_hw_stub_wrapper(__xlx_apatb_param_in0_V, __xlx_apatb_param_out_V);
    port1.buffer();
